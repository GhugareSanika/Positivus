...
//           <div>
//             <h1 className="font-sans font-medium text-[60px] leading-[100%] tracking-normal mb-8">
//               {" "}
//               {/* Reduced mb-16 to mb-8 */}
//               Navigating the digital landscape for success
//             </h1>
//             <p className="text-lg max-w-xl mb-4 font-space font-medium">
//               {" "}
...
//             </p>
//             <Button className="bg-darkNavy font-space text-white hover:bg-gray-800 rounded-lg px-8 py-6 -ml-2">
//               {" "}
    ...
    <>
      <section className="px-4 md:px-8 lg:px-16 pt-12 md:pt-16 pb-0">
        <div className="flex flex-col items-center lg:items-start lg:grid lg:grid-cols-2 gap-8">
          ...
          {/* Image below heading on mobile, beside on desktop */}
