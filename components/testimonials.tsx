...
//         <span className="bg-limeCustom px-4 py-2 text-3xl font-bold inline-block rounded-lg">
//           Testimonials
//         </span>
...
//       <div className="bg-[#191A23] text-white rounded-3xl p-8 md:p-12 max-w-full mx-auto overflow-hidden font-space">
//         <div
//           ref={testimonialRef}
...
//                   index === activeIndex ? "bg-limeCustom" : "bg-gray-600"
//                 }`}
//               />
//             ))}
//           </div>
...
export default function Testimonials() {
  ...
  return (
    <section className="px-4 md:px-8 lg:px-16 py-16 md:py-24">
      ...
      <div className="bg-[#191A23] text-white rounded-3xl p-6 md:p-8 lg:p-12 max-w-full mx-auto overflow-hidden font-space">
        <div
          ref={testimonialRef}
          className="min-h-[250px] md:min-h-[350px] flex items-center justify-center"
        >
          {/* Mobile view - show only current testimonial */}
          <div className="w-full md:hidden">
            <div className="border border-lime-400 rounded-3xl p-6 mb-6">
          ...
          <div
            className="max-w-4xl mx-auto text-center transition-all duration-500 hidden md:block"
            style={{ transform: `translateX(${-activeIndex * 100}%)` }}
          >
            <div
              className="flex transition-transform duration-500"
            ...
            >
              {testimonials.map((testimonial, index) => (
                <div
                  ...
                  style={{ width: `${100 / testimonials.length}%` }}
                >
                  <div className="border border-lime-400 rounded-3xl p-8 lg:p-14 mb-8">
                    <p className="text-lg md:text-xl">"{testimonial.text}"</p>
                  </div>
                  <div className="border-t border-lime-400 pt-4 inline-block">
                    <p className="text-lime-400 font-semibold">
